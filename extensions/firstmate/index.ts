          ...
          case 'task_create': {
            ...
            const details = {
              ...
              argv: {
                ...
                ...(taskIsolation === 'worktree' ? { provisioning: 'Treehouse lease, worker cwd, and branch setup completed.' } : { provisioning: 'Worker started in the requested shared checkout.' }),
